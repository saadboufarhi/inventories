...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="libs\images\management_inventory_icon_216505.ico">
...
<link href="libs\vendor\datepicker\bootstrap-datepicker3-min.css" rel="stylesheet">
</head>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <strong><?php echo date("l j F Y");?></strong>
